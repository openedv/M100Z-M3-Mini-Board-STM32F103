...
We copy the project from  **10_tftlcd** and name both the project and the.ioc file **26_1_dsp_basicmath**. 
...
<img src="../../1_docs/3_figures/26_1_dsp_basicmath/01_dsp.png">

Save these two folders in your path to **Core**.

<img src="../../1_docs/3_figures/26_1_dsp_basicmath/02_file.png">

We can filter the files we need, and we end up with the following files:

<img src="../../1_docs/3_figures/26_1_dsp_basicmath/03.png">


<img src="../../1_docs/3_figures/26_1_dsp_basicmath/04.png">

We modify the configuration to add the corresponding macro definitions.

<img src="../../1_docs/3_figures/26_1_dsp_basicmath/05.png">

Then add the header path. Right click on the project name -> Properties.

<img src="../../1_docs/3_figures/26_1_dsp_basicmath/06.png">
...
<img src="../../1_docs/3_figures/26_1_dsp_basicmath/07.png">
...
int main(void)
{
  ...
  while (1)
  {
    ...
    {
      lcd_show_string(30 + 16 * 8, 150, 100, 16, 16, "errorï¼?", BLUE); /* display errors */
    }
...
<img src="../../1_docs/3_figures/26_1_dsp_basicmath/10.png">
