...
#define USART_REC_LEN             50 * 1024     /* The maximum number of bytes received is defined as 50*1024 */
#define USART_EN_RX                 1           /* Enable (1)/Disable (0) Serial Port 1 Reception */
